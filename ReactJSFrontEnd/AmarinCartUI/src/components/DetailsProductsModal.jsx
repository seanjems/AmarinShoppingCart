...
class DetailsProductsModal extends Component {
  constructor(props) {
    super(props);
          ...
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">
              ...
              <input
                ...
                type="text"
                disabled
                defaultValue={this.props.pproductname}></input>
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
                ...
                <Form typeof="submit">
                  <Form.Group>
                    <div className="col p-2">
                      <label className="row">Product ID</label>
                      <Form.Control
                        disabled
...
export default DetailsProductsModal;
